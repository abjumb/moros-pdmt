...
const OpenTrackingButtonWithTutorialTip = HasTutorialTip(OpenTrackingButton, {
  ...
  instructions: localized(
    'When enabled, Moros will notify you as soon as someone reads this message. Sending to a group? Moros shows you which recipients opened your email so you can follow up with precision.'
  ),
});
