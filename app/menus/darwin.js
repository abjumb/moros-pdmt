  ...
  menu: [
    {
      ...
      label: 'Moros',
      submenu: [
        { label: localized('About Moros'), command: 'application:about' },
        ...
        { type: 'separator' },
        { label: localized('Hide Moros'), command: 'application:hide' },
...

    {
      ...
      submenu: [
        { label: localized('Moros Help'), command: 'application:view-help' },
        { type: 'separator' },
        { label: localized('Getting Started Guide'), command: 'application:view-getting-started' },
        { label: localized('Moros Community'), command: 'application:view-community' },
      ],
    },
  ],
};
