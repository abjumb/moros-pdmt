...
// API Endpoints
export type MorosAPIRequest = typeof import('../flux/mailspring-api-request').default;
...
// Testing
export type MorosTestUtils = typeof import('../../spec/mailspring-test-utils').default;
